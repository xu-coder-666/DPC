...
rec1_base_path='/home/lrx/pcc/mpeg-pcc-tmc13/rec/soldier/raht/r01/ply/'
rec2_base_path='/home/lrx/pcc/mpeg-pcc-tmc13/rec/soldier/raht/r02/ply/'
rec3_base_path='/home/lrx/pcc/mpeg-pcc-tmc13/rec/soldier/raht/r03/ply/'
rec4_base_path='/home/lrx/pcc/mpeg-pcc-tmc13/rec/soldier/raht/r04/ply/'
rec5_base_path='/home/lrx/pcc/mpeg-pcc-tmc13/rec/soldier/raht/r05/ply/'
rec6_base_path='/home/lrx/pcc/mpeg-pcc-tmc13/rec/soldier/raht/r06/ply/'

h5_train='/home/lrx/pcd/GQE-Net/data_LT/h5/2048_2.0_raht_seq3_cubeSearch/'
txt_path='/home/lrx/pcd/GQE-Net/matlab_patch_create/trainFile4.txt'
search_file = '/home/lrx/pcd/GQE-Net/matlab_patch_create/structural_similarity/ply/2048_2.0_raht_seq3_cubeSearch'
...
for i in range(total_lines - seq_len + 1):
    ...
    for m in range(patch_num):
        ...
        for n in range(seq_len):
            ...
            # idxnn_rec_others[m] = full_search(kdtree_rec_base, kdtree_rec_others, rec_locs, 
            #                                   rec_color_yuvs1, ori_color_yuvs, centroid_loc_base[m], patch_pts, sub_dir_name, m, n)

            # _, idxnn_rec_others[m], _ = kdtree_rec_others.search_knn_vector_3d(centroid_loc_base[m], patch_pts)
            # for b in range(patch_num):
            #     # 直接搜索基准帧FPS采样点在其他帧中的最近邻点
            #     _, idxnn_rec_others[b], _ = kdtree_rec_others.search_knn_vector_3d(centroid_loc_base[b], patch_pts)
            #     # _, idxnn_rec_others[b], _ = kdtree_rec_others.search_knn_vector_3d(curPatchLoc_rec_base[b], 1)
            ...
            # otherPatchLoc_rec = rec_locs[n][idxnn_rec_others,:]
            # otherPatchLoc_rec = np.squeeze(otherPatchLoc_rec)
            ...
            # pt_name = os.path.join(sub_dir_name, f"patch{m}_frame{n}.ply")
            # # 创建点云
            # pt = np.hstack([otherPatchLoc_rec, np.clip(np.round(yuv2rgb(otherPatchCol_rec1)), 0, 255)])
            # # 保存点云
...
# h5=h5py.File('data_LT/h5/2048_2.0_nosearch/longdress_vox10_1052_r01.h5','r')
# data=h5['data']
# label=h5['label']